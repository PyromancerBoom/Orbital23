...
func (p *GatewayClient) HelloMethod(ctx context.Context, request *HelloReq) (r *HelloResp, err error) {
	var _args GatewayHelloMethodArgs
	_args.Request = request
	var _result GatewayHelloMethodResult
...
func NewGatewayProcessor(handler Gateway) *GatewayProcessor {
	...
	self.AddToProcessorMap("HelloMethod", &gatewayProcessorHelloMethod{handler: handler})
	return self
}
...
type gatewayProcessorHelloMethod struct {
	handler Gateway
}

func (p *gatewayProcessorHelloMethod) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := GatewayHelloMethodArgs{}
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := GatewayHelloMethodResult{}
...
type GatewayHelloMethodArgs struct {
	Request *HelloReq `thrift:"request,1"`
}

func NewGatewayHelloMethodArgs() *GatewayHelloMethodArgs {
	return &GatewayHelloMethodArgs{}
}

var GatewayHelloMethodArgs_Request_DEFAULT *HelloReq

func (p *GatewayHelloMethodArgs) GetRequest() (v *HelloReq) {
	if !p.IsSetRequest() {
		return GatewayHelloMethodArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_GatewayHelloMethodArgs = map[int16]string{
	1: "request",
}

func (p *GatewayHelloMethodArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *GatewayHelloMethodArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_GatewayHelloMethodArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *GatewayHelloMethodArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *GatewayHelloMethodArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *GatewayHelloMethodArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *GatewayHelloMethodArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("GatewayHelloMethodArgs(%+v)", *p)
}

type GatewayHelloMethodResult struct {
	Success *HelloResp `thrift:"success,0,optional"`
}

func NewGatewayHelloMethodResult() *GatewayHelloMethodResult {
	return &GatewayHelloMethodResult{}
}

var GatewayHelloMethodResult_Success_DEFAULT *HelloResp

func (p *GatewayHelloMethodResult) GetSuccess() (v *HelloResp) {
	if !p.IsSetSuccess() {
		return GatewayHelloMethodResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_GatewayHelloMethodResult = map[int16]string{
	0: "success",
}

func (p *GatewayHelloMethodResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GatewayHelloMethodResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_GatewayHelloMethodResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *GatewayHelloMethodResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *GatewayHelloMethodResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *GatewayHelloMethodResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *GatewayHelloMethodResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("GatewayHelloMethodResult(%+v)", *p)
}
