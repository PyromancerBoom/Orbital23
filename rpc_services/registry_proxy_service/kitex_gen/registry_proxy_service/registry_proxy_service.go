...
type ConnectRequest struct {
	...
	TTL           int64  `thrift:"TTL,5" frugal:"5,default,i64" json:"TTL"`
	TTD           int64  `thrift:"TTD,6" frugal:"6,default,i64" json:"TTD"`
}
...
func (p *ConnectRequest) GetTTL() (v int64) {
	return p.TTL
}

func (p *ConnectRequest) GetTTD() (v int64) {
	return p.TTD
}
...
func (p *ConnectRequest) SetTTL(val int64) {
	p.TTL = val
}
func (p *ConnectRequest) SetTTD(val int64) {
	p.TTD = val
}
...
func (p *ConnectRequest) ReadField5(iprot thrift.TProtocol) error {
...
func (p *ConnectRequest) ReadField6(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.TTD = v
...
func (p *ConnectRequest) writeField5(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("TTL", thrift.I64, 5); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *ConnectRequest) writeField6(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("TTD", thrift.I64, 6); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI64(p.TTD); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *ConnectRequest) DeepEqual(ano *ConnectRequest) bool {
	...
	if !p.Field5DeepEqual(ano.TTL) {
		return false
	}
	if !p.Field6DeepEqual(ano.TTD) {
		return false
	}
	return true
}
...
func (p *ConnectRequest) Field5DeepEqual(src int64) bool {
...
func (p *ConnectRequest) Field6DeepEqual(src int64) bool {
